...
$$\alpha_t=\frac{1}{2}ln(\frac{1-\epsilon_t}{1+\epsilon_t})$$ We use 8 weak learners in AdaBoosting, where each learner is a decision tree with a maximum depth of 4.\\

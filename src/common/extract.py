...
base_features = ['female_hybridscore', 'male_hybridscore', 'female_gendiv', 'male_gendiv', 'gen_distance', 'female_age', 'male_rank', 'female_rank', 'males_present', 'females_present' ] 
...
label_columns = ['consort', 'conceptive'] 
